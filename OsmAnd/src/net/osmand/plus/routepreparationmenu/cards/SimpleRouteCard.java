...
import static net.osmand.plus.utils.OsmAndFormatter.getFormattedFutureTimeShort;
...
public class SimpleRouteCard extends MapBaseCard {
	...
	private void setupArrivalTime(@NonNull SpannableStringBuilder builder) {
		...
		String arriveTime = getFormattedFutureTimeShort(routingHelper.getLeftTime());
